...
/**
 * Component for displaying and managing an offer item.
 * @function OfferItem
 * @param {Object} props - The properties passed to the component.
 * @returns {JSX.Element} The offer item component.
 */
const OfferItem = (props) => {
  
    /**
     * Function to apply to an offer.
     */
...
/**
 * Stylesheet for the OfferItem component.
 */
