...
/**
 * Component for displaying and managing the application item.
...
const ApplicationItem = props => {
    ...
    /**
     * Function to delete the application item.
     */
    function del() {
        ...
        // Determine the command based on the type and state of the content
        if (props.content.type === 'offer') {
            dataToSend.command = props.content.state == 'True'
                ? "delete_confirmed_application_offer"
                : "delete_pending_application_offer";
        } else {
            dataToSend.command = props.content.state == 'True'
                ? "delete_confirmed_application_request"
                : "delete_pending_application_request";
        }
                            ...
                            <View style={{ flexDirection: "column", flex: 1 }}>

                                {
                                    props.content.state == "True"
                                        ? <Image source={require("../assets/pale_checkmark.png")} style={{ height: 200, width: 200, right: 0, top: 30, position: "absolute" }} />
...
/**
 * Stylesheet for the ApplicationItem component.
 */
